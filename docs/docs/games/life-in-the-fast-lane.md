...
> [`../engine/01-vision.md`](../engine/01-vision.md).
...
(§4a of [`../engine/02-architecture.md`](../engine/02-architecture.md)). Same weekly loop and
...
platform has *depth*, and it comes second. See [`../engine/MVP.md`](../engine/MVP.md).
